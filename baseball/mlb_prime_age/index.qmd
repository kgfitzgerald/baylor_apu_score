...
You can investigate an individual player's WAR trajectory over time using the app below. If you're curious, you can see the R code that built the app here and even try making your own! 
