...
::: column-margin
Inter Miami CF opened a $40 million training facility in 2020. It sprawls over 25 acres and includes 7 fields. 

![Inter Miami CF Training Facility](miami_facility.jpg)

Image Source: [Inter Miami CF](https://www.intermiamicf.com/club/facilities/training-center)
:::
...
::: column-margin
**ON THE RISE**
The MLS is rapidly expanding. Since 2015, 10 new teams have joined the league. The league now has 29 teams with a 30th, San Diego, set to join in 2025.

Ratings, attendance, and revenue have all increased dramatically over the last decade.

![](mls_logo.png)
Image Source: [Wikipedia](https://en.wikipedia.org/wiki/Major_League_Soccer)
:::
...
**Fun Fact**: The Seattle Sounders have clearly bought into the idea that new training facilities will help them win more games. Their new facility opened in 2024 and part of its weight room is shown below. 

![Seattle Sounders Training Facility](sounders_facility.jpg)

Image Source: [Seattle Times](https://www.seattletimes.com/sports/sounders/sounders-unveil-new-state-of-the-art-training-facility-heres-a-first-look/)
:::
