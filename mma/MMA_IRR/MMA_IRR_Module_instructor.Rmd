...
**SOLUTION: The interval is entirely in the excellent category so we can reject a null hypothesis of less than excellent reproducability **
...
**SOLUTION: Somewhat.  The highest observed values have relatively high exepected, but some high expected values are not observed often.  **
...
**SOLUTION:  We have too much variability so there is not enough evidence to conclude reproducability is excellent. **
...
**SOLUTION:  No, the interval includes the possiblity of a value that is only good **
