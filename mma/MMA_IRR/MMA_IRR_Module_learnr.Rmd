...
question_radio(
  ...
  answer("65", message = "These are only concordant responses involving fighter 1."),
  answer("71", message = "These are only concordant responses involving fighter 3."),
  answer("73", message = "This is the total times Cleary picked fighter 1."),
  answer("139", correct = TRUE),
  answer("152", message = "This is the total number of responses, not just concordant."),
  allow_retry = TRUE,
...
question_radio(
  ...
  answer("46.7%", message = "Did you use the answer from the previous question?"),
  answer("48%", message = "Did you use the answer from the previous question?"),
  answer("89%", message = "Did you use the answer from the previous question?"),
  answer("91.4%", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("73/79/48%", message = "These are values for Cleary selecting fighter 1."),
  answer("65/8/89%", message = "This is agreement only for fights when Cleary selected fighter 1."),
  answer("139/152/91.4%", message = "We want the number that disagreed rather than the total."),
  answer("139/13/91.4%", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("D'Amato and Lee tend to agree more often"),
  answer("D'Amato and Lee agree the same amount"),
  answer("D'Amato and Lee tend to agree less often", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("They agree very rarely (<50%, 88 times) "),
  answer("Excellent, they only disagree 1 time"),
  answer("Reasonable agreement (less than 30 times disagree)", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
```{r 6, echo=FALSE}
question_radio(
  "2.2. Once again, we’ve left an empty percent agreement table for you (above). Fill in the cells with the appropriate
values and calculate the percent agreement.",
  answer("88/16/84.6%"),
  answer("115/98/54%"),
  answer("186/213/86.8%"),
  answer("186/28/86.8%", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
``` 
...
question_radio(
  ...
  answer("They have much worse agreement than either of the previous examples."),
  answer("They have much better agreement than either of the previous examples."),
  answer("They have agreement about as strong as D'Amato and Cleary"),
  answer("They have slightly better agreement than D'Amato and Lee but not as strong as D'Amato and Cleary", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("They agree very rarely (<50%, 71 times) "),
  answer("Perfect agreement (0 values in the draw column)"),
  answer("Very good agreement (less than 15 times disagree)", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Yes, it shows too much disagreement"),
  answer("No.  Expected values are based on random selections so we would expect about 50 percent agreement", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("This value suggests marginal reproducibility"),
  answer("This value suggests good reproducibility"),
  answer("This value suggests excellent reproducibility", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("The sample size is smaller than previous examples so we will have MORE confidence in the kappa estimate"),
  answer("The sample size is larger than previous examples so we will have MORE confidence in the kappa estimate"),
  answer("The sample size is larger than previous examples so we will have LESS confidence in the kappa estimate"),
  answer("The sample size is smaller than previous examples so we will have LESS confidence in the kappa estimate", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("They almost never"),
  answer("The agree almost perfectly"),
  answer("They do disagree a fair amount relative to the sample size, but still near 80 percent", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Very surprising.  Expected agreement is as high as the observed."),
  answer("Expected agreement is roughly 50 percent so not surprising.", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("This value suggests marginal reproducibility, much worse than previous examples", correct = TRUE),
  answer("This value suggests good reproducibility, somewhat lower than previous examples"),
  answer("This value suggests excellent reproducibility similar to previous examples"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("The interval provides strong evidence of marginal reproducibility", correct = TRUE),
  answer("The small sample leads to a wide interval so the reproducibility has high probability of still being excellent"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("69 times, 58 percent", correct = TRUE),
  answer("8 times, 7 percent"),
  answer("97 times, 82 percent"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Agreement about the fight outcome (winner) but Lee had a wider margin in scores", correct = TRUE),
  answer("Agreement about the fight outcome (winner) but D'Amato had a wider margin in scores"),
  answer("Disagreement about the fight outcome with the judges picking different winners"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("0.  There are many possible score combinations for the size of the sample.", correct = TRUE),
  answer("0.  The judges disagree too much."),
  answer("18.  Score differences of three are very likely since fights are three rounds."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("All less than 10.  There are many possible score combinations for the size of the sample.", correct = TRUE),
  answer("Large differences between judges (5 and -5).  The judges should be expected to disagree by a lot."),
  answer("All diagnonal values.  The judges are expected to agree often."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Yes.  58 observed vs 18 percent expected.", correct = TRUE),
  answer("No.  58 observed vs 78 percent expected."),
  answer("Yes.  82 observed vs 58 percent expected."),
  answer("No  7 observed vs 58 percent expected."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("83 times (71 percent)", correct = TRUE),
  answer("71 times (61 percent)"),
  answer("98 times (84 percent)"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Yes.  There are only 7 times one is positive and the other negative.", correct = TRUE),
  answer("No.  There are many values in the off diagnonal.", 
         message = "Not all off diagnonal values represent differences in which fighter wins."),
  answer("Yes.  There are few values in the off diagnonal.",
         message = "Not all off diagnonal values represent differences in which fighter wins."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
...
question_radio(
  ...
  answer("They agree more.  (71 vs 58 percent)", correct = TRUE),
  answer("They agree less  (58 vs 71 percent)"),
  answer("They agree much less  (28 vs 71 percent)"),
  answer("They agree much more  (92 vs 58 percent)"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Somewhat.  The highest observed values have relatively high exepected, but some high expected values are not observed often.", correct = TRUE),
  answer("No.  The highest observed values of 20 are 0 in the expected table."),
  answer("Yes. The highest expected values of 5 and above are all observed at least 10 times. "),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Yes, the kappa value is over 0.9.", correct = TRUE),
  answer("No.  The observed agreement is not much better than the expected."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("We have evidence to support excellent reproducibility for these two judges.", correct = TRUE),
  answer("We have too much variability so there is not enough evidence to conclude reproducability is excellent."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("We have evidence to support excellent reproducibility for these two judges."),
  answer("We have too much variability so there is not enough evidence to conclude reproducability is excellent.", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Hardly any difference so the choice does not matter here."),
  answer("A large enough difference to matter when drawing inference from the confidence interval.", correct = TRUE),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("All but one fight", correct = TRUE),
  answer("About half of the fights"),
  answer("Very rarely (less than 20 percent)"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Most fights (12 of 15)", correct = TRUE),
  answer("About half of the fights"),
  answer("Very rarely (less than 20 percent)"),
  allow_retry = TRUE,
  random_answer_order = TRUE
...
question_radio(
  ...
  answer("Yes, Cartlidge is the only one to disagree", correct = TRUE),
  answer("No, they all disagree at least one time"),
  answer("Yes, Sledge disagrees the most"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Just over half (53 percent)", correct = TRUE),
  answer("Most (about 84 percent)"),
  answer("About two thirds (65 percent)"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("Excellent, well above chance agreement (over 90 percent)", correct = TRUE),
  answer("Good, higher than chance agreement (84 percent) "),
  answer("Marginal, not much better than chance agreement (65 percent)"),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
...
question_radio(
  ...
  answer("No, the interval includes the possiblity of a value that is only good", correct = TRUE),
  answer("Yes, we reject that kappa is equal to 0"),
  answer("Cannot determine from the information provided."),
  allow_retry = TRUE,
  random_answer_order = TRUE
)
```
